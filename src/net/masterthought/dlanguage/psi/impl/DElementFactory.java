...
public class DElementFactory {
    ...
    public static DLanguageAggregateDeclaration createDLanguageAggregateDeclarationFromText(@NotNull Project project, @NotNull String name) {
        return ((DLanguageAggregateDeclaration) (createExpressionFromText(project, name + "uniq = " + name)).getFirstChild());
    }
    ...
    public static DLanguageSymbol createDSymbolFromText(@NotNull Project project, @NotNull String name) {
