...
//                namedElements = PsiTreeUtil.findChildrenOfType(file, (Class<? extends PsiNamedElement>) DDefinitionFunction.class);
    ...
    public static boolean definitionNode(@NotNull PsiNamedElement e) {
        ...
        if (e instanceof DLanguageAggregateDeclaration) return definitionNode((DLanguageAggregateDeclaration) e);
        return false;
    }
    ...
    public static boolean definitionNode(@NotNull DLanguageAggregateDeclaration e) {
        return true;
    }
